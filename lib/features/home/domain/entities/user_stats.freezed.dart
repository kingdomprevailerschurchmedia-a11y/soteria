...
mixin _$UserStats {
 ...
 int get level; double get xpProgress; int get coins; int get streakDays; int get lives; String get rank;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,level,xpProgress,coins,streakDays,lives,rank);

@override
String toString() {
  return 'UserStats(level: $level, xpProgress: $xpProgress, coins: $coins, streakDays: $streakDays, lives: $lives, rank: $rank)';
}
...
@useResult
$Res call({
 int level, double xpProgress, int coins, int streakDays, int lives, String rank
});
...
/// Create a copy of UserStats
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? level = null,Object? xpProgress = null,Object? coins = null,Object? streakDays = null,Object? lives = null,Object? rank = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int level,  double xpProgress,  int coins,  int streakDays,  int lives,  String rank)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserStats() when $default != null:
return $default(_that.level,_that.xpProgress,_that.coins,_that.streakDays,_that.lives,_that.rank);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int level,  double xpProgress,  int coins,  int streakDays,  int lives,  String rank)  $default,) {final _that = this;
switch (_that) {
case _UserStats():
return $default(_that.level,_that.xpProgress,_that.coins,_that.streakDays,_that.lives,_that.rank);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int level,  double xpProgress,  int coins,  int streakDays,  int lives,  String rank)?  $default,) {final _that = this;
switch (_that) {
case _UserStats() when $default != null:
return $default(_that.level,_that.xpProgress,_that.coins,_that.streakDays,_that.lives,_that.rank);case _:
  return null;
...
class _UserStats implements UserStats {
  const _UserStats({required this.level, required this.xpProgress, required this.coins, required this.streakDays, required this.lives, required this.rank});
...
/// Create a copy of UserStats
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? level = null,Object? xpProgress = null,Object? coins = null,Object? streakDays = null,Object? lives = null,Object? rank = null,}) {
