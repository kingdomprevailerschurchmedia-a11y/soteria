...
@override
String toString() {
  return 'AuthUser(id: $id, email: $email, username: $username, avatarUrl: $avatarUrl, isGuest: $isGuest)';
}
...
class _AuthUser implements AuthUser {
  const _AuthUser({required this.id, required this.email, required this.username, this.avatarUrl, this.isGuest = false});
