...
mixin _$AuthSession {
 ...
 String get accessToken; DateTime get expiresAt; String? get refreshToken; bool get isPersistent;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthSession&&(identical(other.accessToken, accessToken) || other.accessToken == accessToken)&&(identical(other.expiresAt, expiresAt) || other.expiresAt == expiresAt)&&(identical(other.refreshToken, refreshToken) || other.refreshToken == refreshToken)&&(identical(other.isPersistent, isPersistent) || other.isPersistent == isPersistent));
}


@override
int get hashCode => Object.hash(runtimeType,accessToken,expiresAt,refreshToken,isPersistent);

@override
String toString() {
  return 'AuthSession(accessToken: $accessToken, expiresAt: $expiresAt, refreshToken: $refreshToken, isPersistent: $isPersistent)';
}
...
@useResult
$Res call({
 String accessToken, DateTime expiresAt, String? refreshToken, bool isPersistent
});
...
/// Create a copy of AuthSession
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = null,Object? expiresAt = null,Object? refreshToken = freezed,Object? isPersistent = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String accessToken,  DateTime expiresAt,  String? refreshToken,  bool isPersistent)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthSession() when $default != null:
return $default(_that.accessToken,_that.expiresAt,_that.refreshToken,_that.isPersistent);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String accessToken,  DateTime expiresAt,  String? refreshToken,  bool isPersistent)  $default,) {final _that = this;
switch (_that) {
case _AuthSession():
return $default(_that.accessToken,_that.expiresAt,_that.refreshToken,_that.isPersistent);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String accessToken,  DateTime expiresAt,  String? refreshToken,  bool isPersistent)?  $default,) {final _that = this;
switch (_that) {
case _AuthSession() when $default != null:
return $default(_that.accessToken,_that.expiresAt,_that.refreshToken,_that.isPersistent);case _:
  return null;
...
class _AuthSession extends AuthSession {
  const _AuthSession({required this.accessToken, required this.expiresAt, this.refreshToken, this.isPersistent = false}): super._();
  

@override final  String accessToken;
@override final  DateTime expiresAt;
@override final  String? refreshToken;
@override@JsonKey() final  bool isPersistent;
...
/// Create a copy of AuthSession
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = null,Object? expiresAt = null,Object? refreshToken = freezed,Object? isPersistent = null,}) {
